...
<html lang="vi">
	...
	<title>Đăng nhập &lsaquo; Duc Manh Blog &#8212; WordPress</title>
...
<script type="text/javascript">
            ...
            </script><link rel="stylesheet" id="dashicons-css" href="/wp-includes/css/dashicons.min.css?ver=5.8.1" type="text/css" media="all">
		...
		<form name="loginform" id="loginform" action="/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
									<input type="hidden" name="redirect_to" value="http://localhost:8888/ducmanh/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
								<a href="/my-account/lost-password/">Bạn quên mật khẩu?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Quay lại Duc Manh Blog</a>		</p>
			</div>
	<script type="text/javascript" src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.0" id="jquery-core-js"></script>
<script type="text/javascript" src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script type="text/javascript" id="zxcvbn-async-js-extra">
/*  */
var _zxcvbnSettings = {"src":"http:\/\/localhost:8888\/ducmanh\/wp-includes\/js\/zxcvbn.min.js"};
/*  */
</script>
...
/*  */
var _wpUtilSettings = {"ajax":{"url":"\/ducmanh\/wp-admin\/admin-ajax.php"}};
/*  */
</script>
<script type="text/javascript" src="/wp-includes/js/wp-util.min.js?ver=5.8.1" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">
/*  */
var userProfileL10n = {"user_id":"0","nonce":"5e994082a6"};
/*  */
</script>
